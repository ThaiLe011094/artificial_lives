...
class VirtualOrganismEnv(gym.Env):
    ...
    def reset(self):
        ...
        self.steps = 0
        return np.concatenate((self.organism_pos, self.food_pos)).astype(np.float32)
    ...
    def step(self, action):
        ...
        return np.concatenate((self.organism_pos, self.food_pos)).astype(np.float32), reward, done, {}
