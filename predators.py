...
class Predator:
    def __init__(
        ...
        image_path = random.choice(config.PREDATOR_IMG_PATH)
        self.image = pygame.image.load(image_path)
        self.avatar = pygame.transform.scale(self.image, config.PREDATOR_IMG_SIZE)
    ...
    def render(self, screen):
        if self.alive:
            ...
            #pygame.draw.circle(screen, config.ORANGE, (int(self.x), int(self.y)), self.size)  # circle as avatar
